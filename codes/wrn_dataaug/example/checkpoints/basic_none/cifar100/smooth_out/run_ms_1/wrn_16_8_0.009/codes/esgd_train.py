...
def main():
    ...
    # optim config
    parser.add_argument("--epochs", default=8, type=int, help="Total number of epochs.")
    ...
    args.cp_dir = f"checkpoints/{args.img_aug}/{args.dtype}/esgd/run_ms_{args.seed}/" + \
                  ...
                  f"run_{args.g0}_{args.g1}_{args.sgld_lr}_{args.learning_rate}_25"
    ...
    optimizer = EntropySGD(
        ...
        dict(lr=args.learning_rate, 
             ...
             weight_decay=args.weight_decay, L=25,
             eps=1e-4, g0=args.g0, g1=args.g1, gmax=1, 
             epochs=args.epochs, sgld_lr=args.sgld_lr, alpha_arg=0.75, gscale=True))

    # initialize scheduler
    if args.mtype == "wrn":
        scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [2,4,6], gamma=0.2)
    elif args.mtype == "shakeshake":
