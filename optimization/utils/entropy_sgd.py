...
class EntropySGD(Optimizer):
    ...
    def __init__(self, params, wd=5e-4, lr=0.1, momentum=0, L=5, gamma_0=0.0001, gamma_1=0.001, eta_prime = 0.01, epsilon=0.0001, alpha=0.75, nesterov=False):
