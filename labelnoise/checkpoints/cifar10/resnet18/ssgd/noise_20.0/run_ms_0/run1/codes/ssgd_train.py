...
if __name__ == "__main__":
    ...
    # ssgd parameters
    parser.add_argument("--std", default=0.0001, type=float)
    parser.add_argument("--M", default=1, type=int)
    parser.add_argument("--inc", default=15, type=int, help="increase")
    ...
    args.n = f"{args.dtype}/{args.mtype}/ssgd"
