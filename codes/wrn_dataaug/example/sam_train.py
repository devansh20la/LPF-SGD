...
if __name__ == "__main__":
    ...
    args.cp_dir = f"checkpoints/{args.img_aug}/{args.dtype}/sam/run_ms_{args.seed}/{args.mtype}_{args.depth}_bottleneck"
    ...
    if args.resume is not None:
        ...
        # RESUMING DOES NOT WORK AS OF NOW
    else:
        start_epoch = 0
        state = {
            'epoch': 1,
