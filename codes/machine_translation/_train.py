...
if __name__ == "__main__":
	...
	model = Seq2SeqTransformer(
		...
		emb_size=512,
		nhead=8,
		src_vocab_size=bpe_model.vocab_size(),
		tgt_vocab_size=bpe_model.vocab_size(),
		dim_feedforward=512,
		dropout=args.dp
	)
	...
	while (step < args.ts):
		...
		inputs = "Die Führungskräfte der Republikaner rechtfertigen ihre Politik mit der Notwendigkeit, den Wahlbetrug zu bekämpfen."
