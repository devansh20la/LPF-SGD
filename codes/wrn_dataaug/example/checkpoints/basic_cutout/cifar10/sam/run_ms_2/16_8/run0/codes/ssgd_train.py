...
import torch
import os
from model.wide_res_net2 import Wide_ResNet
...
if __name__ == "__main__":
    ...
    if args.dtype == 'cifar100':
        ...
        model = Wide_ResNet(args.depth, args.width_factor, args.dropout,num_classes=100).to(device)
    else:
        dataset = Cifar(args.batch_size, args.threads)
        model = Wide_ResNet(args.depth, args.width_factor, args.dropout,num_classes=10).to(device)
